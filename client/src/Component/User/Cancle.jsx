...
export default function Cancle() {
    ...
    useEffect(() => {
        ...
        axios({
            method: 'get',
            url: url + "/AllDataStatusOrderCancel",
        }).then((response) => {

            setProducts(response.data.data)
            // console.log(response, "AllDataStatusOrderCancel response");
    ...
    return (
        <div>
            ...
            <div>
                <div className="p-4">
                    <h1 className="text-center ">Cancle orders</h1>
                                ...
                                return (
                                    <div key={index}>
                                        <div>
                                            ...
                                            <h3>Order#{index}</h3>
                                            <h3 className="text-right "><button type="button" class="btn btn-danger btn-rounded">Order Status : {status}</button></h3>
                                            {/* <button type="button" class="btn btn-danger btn-rounded">{status}</button> */}
                                        </div>
                                        <div>
